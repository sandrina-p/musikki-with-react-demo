...
class Sign extends React.Component {
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                "form",
                { className: "Form", onSubmit: this._handleForm },
                React.createElement(
                    "div",
                    { className: "Form-body" },
                    React.createElement(
                    ...
                    React.createElement(
                        "p",
                        { className: "InputSide" },
                        React.createElement("input", { id: "password", type: "pass", name: "password", placeholder: "123rty", ref: input => this._password = input }),
                        React.createElement(
                            "label",
                            { htmlFor: "password" },
                            "Password"
