...
class Search extends React.Component {
    ...
    render() {
        const artistsLi = this._getArtists();
        let artistsUl = <div className="ArtistsList">{artistsLi}</div>
        ...
        return (
            <div>
                <div className="InputSearch">
                    ...
                    <input id="searchArtist" type="text" name="searchArtist" placeholder="Artist Name" ref={(input) => this._search = input} onChange={this._onSearch}/>
